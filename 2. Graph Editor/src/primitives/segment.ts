import type { SegmentDrawOptions, PointClass, SegmentClass } from "./primitiveTypes";
import type { MathPoint } from "../math/mathTypes";
...
class Segment implements SegmentClass {
   ...
   */
  includes(point: MathPoint): boolean {
   ...
   */
  draw(ctx: CanvasRenderingContext2D, { width = 2, color = "black", dash = [] }: SegmentDrawOptions = {}): void {
    ctx.beginPath();
